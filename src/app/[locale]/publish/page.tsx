...
import type { Mention, ProfileListItem, Locale } from '@/types';
    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-8rem)]">
         <Alert variant="destructive" className="max-w-lg">
                ...
                <AlertDescription>
                   Debes <a href={`/${locale}/login`} className='underline font-bold'>iniciar sesión</a> para poder publicar en la comunidad.
                </AlertDescription>
         </Alert>
        </div>
    );
